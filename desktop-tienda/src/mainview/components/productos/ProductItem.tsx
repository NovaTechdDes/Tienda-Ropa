  ...
  return (
    ...
    >
      ...
      <div className="relative h-56 w-full overflow-hidden bg-[#0a0a0b]">
        ...
        <p className="absolute top-2 right-2 bg-yellow-500/80 text-black p-1 rounded-lg z-10 text-xs font-medium leading-relaxed line-clamp-2">$ {producto.precio_global?.toFixed(2) ?? '0.00'}</p>
      </div>
        ...
        <div className="grid grid-cols-2 gap-3 mb-6">
          <div className="flex items-center gap-2 px-3 py-2 rounded-xl bg-[#0a0a0b] border border-[rgba(255,255,255,0.04)]">
            ...
            <div className="flex flex-col">
              <span className="text-[9px] uppercase tracking-widest text-[#3f3f46] font-bold leading-none mb-1">Variantes</span>
              <span className="text-xs text-[#f5f5f0] font-bold leading-none">{variantsCount}</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 px-3 py-2 rounded-xl bg-[#0a0a0b] border border-[rgba(255,255,255,0.04)]">
            ...
            <div className="flex flex-col">
              <span className="text-[9px] uppercase tracking-widest text-[#3f3f46] font-bold leading-none mb-1">Total Items</span>
              <span className="text-xs text-[#f5f5f0] font-bold leading-none">{totalStock.toFixed(2)}</span>
            </div>
          </div>
        </div>
