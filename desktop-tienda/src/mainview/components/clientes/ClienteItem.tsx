    ...
    <tr className="group">
      ...
      <td className="bg-[#141416]/50 group-hover:bg-[#141416] border-y border-l border-white/5 group-hover:border-[#d4af37]/20 rounded-l-2xl px-6 py-5 transition-all duration-300">
        <div className="flex items-center gap-4">
          ...
          <div className="flex flex-col text-left">
            <span className="text-sm font-bold text-[#f5f5f0] tracking-tight mb-0.5 group-hover:text-white transition-colors uppercase">
              {cliente.nombre}
            </span>
      ...
      <td className="bg-[#141416]/50 group-hover:bg-[#141416] border-y border-white/5 group-hover:border-[#d4af37]/20 px-6 py-5 transition-all duration-300">
        <div className="flex justify-center gap-8">
          ...
          <div className="flex flex-col items-center">
            <span className="text-[9px] uppercase tracking-[0.2em] text-[#3f3f46] font-bold mb-1.5">Invertido</span>
      ...
      <td className="bg-[#141416]/50 group-hover:bg-[#141416] border-y border-r border-white/5 group-hover:border-[#d4af37]/20 rounded-r-2xl px-6 py-5 text-right transition-all duration-300">
        ...
        <div className="flex justify-end gap-2.5 opacity-40 group-hover:opacity-100 transition-opacity duration-300">
          <button className="p-2.5 bg-white/5 hover:bg-[#d4af37]/10 text-white/40 hover:text-[#d4af37] rounded-xl transition-all duration-300 border border-white/5 hover:border-[#d4af37]/30 group/btn shadow-lg">
            <Pencil size={16} className="transition-transform group-hover/btn:-translate-y-0.5" />
          </button>
          <button onClick={eliminarCliente} className="p-2.5 bg-red-500/5 hover:bg-red-500/10 text-red-500/40 hover:text-red-500 rounded-xl transition-all duration-300 border border-red-500/10 hover:border-red-500/30 group/del shadow-lg">
